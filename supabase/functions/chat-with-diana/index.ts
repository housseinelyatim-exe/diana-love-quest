  ...
  try {
    ...
    if (!message || message.trim() === "") {
      ...
      const greetings: Record<string, string> = {
        en: "Hi! I'm Diana, your personal matchmaking assistant 💝\n\nWelcome to a new way of finding meaningful connections. Let me explain how this works:\n\nHow Our Matching System Works:\n\nI'll have a natural conversation with you to build your complete profile. Through our chat, I'll ask thoughtful questions about different aspects of your life - your background, values, lifestyle, career, hobbies, travel preferences, family goals, and what you're looking for in a partner.\n\nThe questions are organized into categories like basics, location, family, career, beliefs, hobbies, travel, and relationship preferences. You can see your progress as we go through each category.\n\nYour Choice, Your Pace:\n\nHere's something important - while some basic questions are required (like your name, age, and gender), MOST questions are completely optional. You can skip any question by simply saying \"skip\", \"pass\", or \"prefer not to say\".\n\nHowever, here's the key: The more you answer, the better your matches will be!\n\nThink of it like this - each answer you provide helps our algorithm paint a more complete picture of who you are. The more colors in that picture, the more accurately we can find someone who truly complements you. Skipping questions is totally fine, but every answer you give increases your chances of finding that perfect match.\n\nYour Profile Matters:\n\nEvery detail you share helps our intelligent matching algorithm understand you better. The more complete your profile, the more accurate your matches will be. When your profile reaches 100% completion, I'll automatically generate a personalized bio that captures who you are.\n\nFinding Your Matches:\n\nOnce your profile is at least 50% complete, you'll unlock the Discover section where you can see potential matches. Our algorithm analyzes compatibility across multiple dimensions - shared values, lifestyle compatibility, relationship goals, and personal preferences - to find people who truly align with you.\n\nPrivacy and Security:\n\nYour information is private and secure. You control what you share and when. You decide who you want to connect with, and conversations only happen when there's mutual interest.\n\nReady to Start:\n\nThis is more than just filling out a form - it's a conversation. I'm here to listen, understand, and help you find someone special. Feel free to ask me questions anytime about how things work.\n\nLet's begin with the basics. What's your name?",
        fr: "Bonjour ! Je suis Diana, votre assistante personnelle de matchmaking 💝\n\nBienvenue dans une nouvelle façon de trouver des connexions significatives. Laissez-moi vous expliquer comment cela fonctionne :\n\nComment Fonctionne Notre Système de Matching :\n\nJe vais avoir une conversation naturelle avec vous pour construire votre profil complet. À travers notre chat, je poserai des questions réfléchies sur différents aspects de votre vie - votre parcours, vos valeurs, votre style de vie, votre carrière, vos loisirs, vos préférences de voyage, vos objectifs familiaux et ce que vous recherchez chez un partenaire.\n\nLes questions sont organisées en catégories comme les bases, la localisation, la famille, la carrière, les croyances, les loisirs, les voyages et les préférences relationnelles. Vous pouvez voir votre progression au fur et à mesure que nous parcourons chaque catégorie.\n\nVotre Choix, Votre Rythme :\n\nVoici quelque chose d'important - bien que certaines questions de base soient requises (comme votre nom, âge et sexe), la PLUPART des questions sont complètement optionnelles. Vous pouvez passer n'importe quelle question en disant simplement \"passer\", \"suivant\" ou \"préfère ne pas dire\".\n\nCependant, voici la clé : Plus vous répondez, meilleurs seront vos matchs !\n\nPensez-y comme ceci - chaque réponse que vous donnez aide notre algorithme à peindre une image plus complète de qui vous êtes. Plus il y a de couleurs dans cette image, plus nous pouvons trouver avec précision quelqu'un qui vous complète vraiment. Passer des questions est tout à fait acceptable, mais chaque réponse que vous donnez augmente vos chances de trouver ce match parfait.\n\nVotre Profil Compte :\n\nChaque détail que vous partagez aide notre algorithme de matching intelligent à mieux vous comprendre. Plus votre profil est complet, plus vos matchs seront précis. Lorsque votre profil atteint 100% de complétion, je génère automatiquement une bio personnalisée qui capture qui vous êtes.\n\nTrouver Vos Matchs :\n\nUne fois que votre profil est complété à au moins 50%, vous débloquerez la section Découverte où vous pourrez voir les matchs potentiels. Notre algorithme analyse la compatibilité à travers plusieurs dimensions - valeurs partagées, compatibilité de style de vie, objectifs relationnels et préférences personnelles - pour trouver des personnes qui vous correspondent vraiment.\n\nConfidentialité et Sécurité :\n\nVos informations sont privées et sécurisées. Vous contrôlez ce que vous partagez et quand. Vous décidez avec qui vous voulez vous connecter, et les conversations ne se produisent que lorsqu'il y a un intérêt mutuel.\n\nPrêt à Commencer :\n\nC'est plus qu'un simple remplissage de formulaire - c'est une conversation. Je suis là pour écouter, comprendre et vous aider à trouver quelqu'un de spécial. N'hésitez pas à me poser des questions à tout moment sur le fonctionnement.\n\nCommençons par les bases. Quel est votre nom ?",
        ar: "مرحباً! أنا ديانا، مساعدتك الشخصية في إيجاد شريك الحياة 💝\n\nمرحباً بك في طريقة جديدة للعثور على علاقات ذات معنى. دعني أشرح لك كيف يعمل هذا:\n\nكيف يعمل نظام المطابقة لدينا:\n\nسأجري معك محادثة طبيعية لبناء ملفك الشخصي الكامل. من خلال محادثتنا، سأطرح أسئلة مدروسة حول جوانب مختلفة من حياتك - خلفيتك، قيمك، أسلوب حياتك، مهنتك، هواياتك، تفضيلات السفر، أهدافك العائلية، وما تبحث عنه في الشريك.\n\nالأسئلة منظمة في فئات مثل الأساسيات، الموقع، العائلة، المهنة، المعتقدات، الهوايات، السفر، وتفضيلات العلاقة. يمكنك رؤية تقدمك بينما نمر بكل فئة.\n\nاختيارك، وتيرتك:\n\nهذا شيء مهم - بينما بعض الأسئلة الأساسية مطلوبة (مثل اسمك وعمرك وجنسك)، معظم الأسئلة اختيارية تماماً. يمكنك تخطي أي سؤال بقول \"تخطي\" أو \"التالي\" أو \"أفضل عدم الإجابة\".\n\nومع ذلك، إليك النقطة الأساسية: كلما أجبت أكثر، كانت مطابقاتك أفضل!\n\nفكر في الأمر هكذا - كل إجابة تقدمها تساعد خوارزميتنا على رسم صورة أكثر اكتمالاً لمن أنت. كلما كان هناك المزيد من الألوان في تلك الصورة، كلما تمكنا من إيجاد شخص يكملك حقاً بدقة أكبر. تخطي الأسئلة أمر جيد تماماً، لكن كل إجابة تقدمها تزيد من فرصك في إيجاد ذلك التطابق المثالي.\n\nملفك الشخصي مهم:\n\nكل تفصيل تشاركه يساعد خوارزمية المطابقة الذكية لدينا على فهمك بشكل أفضل. كلما كان ملفك أكثر اكتمالاً، كانت مطابقاتك أكثر دقة. عندما يصل ملفك إلى اكتمال 100%، سأقوم تلقائياً بإنشاء سيرة ذاتية شخصية تجسد من أنت.\n\nالعثور على مطابقاتك:\n\nبمجرد أن يصل ملفك الشخصي إلى 50% على الأقل من الاكتمال، ستفتح قسم الاكتشاف حيث يمكنك رؤية المطابقات المحتملة. تحلل خوارزميتنا التوافق عبر أبعاد متعددة - القيم المشتركة، توافق أسلوب الحياة، أهداف العلاقة، والتفضيلات الشخصية - للعثور على أشخاص يتوافقون معك حقاً.\n\nالخصوصية والأمان:\n\nمعلوماتك خاصة وآمنة. أنت تتحكم فيما تشاركه ومتى. أنت تقرر مع من تريد التواصل، والمحادثات تحدث فقط عندما يكون هناك اهتمام متبادل.\n\nجاهز للبدء:\n\nهذا أكثر من مجرد ملء نموذج - إنها محادثة. أنا هنا للاستماع والفهم ومساعدتك في العثور على شخص مميز. لا تتردد في طرح الأسئلة علي في أي وقت حول كيفية عمل الأشياء.\n\nلنبدأ بالأساسيات. ما اسمك؟",
        tn: "مرحبا! أنا ديانا، مساعدتك الشخصية باش تلقى شريك حياتك 💝\n\nمرحبا بيك في طريقة جديدة باش تلقى علاقات معناها. خليني نشرحلك كيفاش يخدم هذا:\n\nكيفاش يخدم نظام الماتشينغ متاعنا:\n\nباش نعمل معاك حديث طبيعي باش نبنيو البروفايل الكامل متاعك. من خلال الشات متاعنا، باش نسألك أسئلة مدروسة على حاجات مختلفة من حياتك - الخلفية متاعك، القيم متاعك، ستايل الحياة، الخدمة، الهوايات، تفضيلات السفر، الأهداف العائلية، وشنوا تحب تلقى في الشريك.\n\nالأسئلة منظمين في كاتيغوريات كيما الأساسيات، الموقع، العائلة، الخدمة، المعتقدات، الهوايات، السفر، وتفضيلات العلاقة. تنجم تشوف التقدم متاعك كل ما نعديو على كل كاتيغوري.\n\nالاختيار متاعك، الإيقاع متاعك:\n\nهاذي حاجة مهمة - رغم إلي بعض الأسئلة الأساسية مطلوبة (كيما اسمك وعمرك وجنسك)، معظم الأسئلة اختيارية تماماً. تنجم تعدي أي سؤال بكل بساطة كان تقول \"تعدّى\"، \"السؤال الجاي\" أو \"نحب ما نجاوبش\".\n\nأما هوني المفتاح: كل ما تجاوب أكثر، كل ما الماتشات متاعك يكونو أحسن!\n\nفكّر فيها هكّا - كل جواب تعطيه يساعد الخوارزمية متاعنا باش ترسم صورة أكمل عليك. كل ما فما ألوان أكثر في الصورة هاذي، كل ما نقدرو نلقاو بدقة أكبر شكون يكمّلك فعلاً. تعدية الأسئلة ماهي مشكلة، أما كل جواب تعطيه يزيد من فرصك باش تلقى الماتش المثالي.\n\nالبروفايل متاعك مهم:\n\nكل تفصيلة تشاركها تساعد الخوارزمية الذكية متاعنا باش تفهمك أحسن. كل ما البروفايل متاعك يكون كامل أكثر، كل ما الماتشات يكونو أدق. كي البروفايل متاعك يوصل 100% كامل، باش نجينيريلك بيو شخصية بشكل أوتوماتيكي تعبر عليك.\n\nلقاء الماتشات متاعك:\n\nكي البروفايل متاعك يوصل على الأقل 50% كامل، باش تفتحلك سيكسيون الديسكوفر وين تنجم تشوف الماتشات المحتملة. الخوارزمية متاعنا تحلل التوافق من أبعاد متعددة - القيم المشتركة، توافق ستايل الحياة، أهداف العلاقة، والتفضيلات الشخصية - باش تلقالك ناس لي يتوافقو معاك برشا.\n\nالخصوصية والأمان:\n\nالمعلومات متاعك خاصة وآمنة. إنت لي تتحكم في شنوا تشارك ووقتاش. إنت لي تقرر مع شكون تحب تتواصل، والمحادثات يصيرو برك كان فما اهتمام مشترك.\n\nواجد باش نبداو:\n\nهذا أكثر من مجرد تعبية فورميلار - هي محادثة. أنا هنا باش نسمع، نفهم، ونساعدك تلقى شخص مميز. لا تتردد تسألني أسئلة في أي وقت على كيفاش تخدم الأمور.\n\nخلينا نبداو بالأساسيات. شنوّا اسمك؟",
      };
